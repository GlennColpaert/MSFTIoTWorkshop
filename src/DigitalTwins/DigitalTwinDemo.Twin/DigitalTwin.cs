...
namespace DigitalTwinDemo.Twin
{
    public class DigitalTwin
    {
        ...
        {         
            ...
            await _client.CreateDigitalTwinAsync("House", JsonSerializer.Serialize(twinData));
            Console.WriteLine($"House Twin created successfully!");
            ...
            await _client.CreateRelationshipAsync("House", "house_to_Floor1", JsonSerializer.Serialize(body));
            Console.WriteLine($"Relationship house_to_Floor1 created successfully!");
            ...
            await _client.CreateRelationshipAsync("House", "house_to_floor2", JsonSerializer.Serialize(body));
            Console.WriteLine($"Relationship house_to_floor2 created successfully!");
            ...
            await _client.CreateRelationshipAsync("House", "house_to_floor3", JsonSerializer.Serialize(body));
            Console.WriteLine($"Relationship house_to_floor3 created successfully!");
